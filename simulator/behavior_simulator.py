...
class BehaviorSimulator:
    ...
    def build_profile(self, audience: str, permissions_granted: bool) -> UserProfile:
        presets = {
            "student": dict(name="Lina", age_group="teen", notifications=86, social=4.4, sleep=6.3, planning=58, sessions=7),
            "young-adult": dict(name="Adam", age_group="young_adult", notifications=73, social=3.7, sleep=6.9, planning=63, sessions=8),
            "child": dict(name="Youssef", age_group="child", notifications=48, social=2.2, sleep=8.1, planning=52, sessions=6),
        }
